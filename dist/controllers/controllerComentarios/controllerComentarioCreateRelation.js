...
exports.controllerComentarioCreateRelation = void 0;
const prismaClient_1 = require("../../prisma_Client_Orm/prismaClient");
class controllerComentarioCreateRelation {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id_comentario, id_product, } = request.body;
            if (typeof id_comentario === 'number' ||
        ...
        Ou o id esta errado, verifique novamente`
            ...
            const productCategory = yield prismaClient_1.prisma.comentarioRealations.create({
                data: {
                    id_comentario,
                    id_product,
                },
...
exports.controllerComentarioCreateRelation = controllerComentarioCreateRelation;
